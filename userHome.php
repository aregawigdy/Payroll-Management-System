    ...
    <div class="scroll">
				...
				<div id="contact_form">
					<div class="panel" id="uname">
						<form method="post" name="contact" action="">
								...
								<br/>							                                
                                <center><input type="submit" class="submit_btn" name="submituser" id="submit" value="Change" />
				...
				<div id="contact_form">
					<div class="panel" id="password">
						<form method="post" name="contact" action="">
								...
								<br>							                                
                                <center><input type="submit" class="submit_btn" name="submitpass" id="submit" value="Change" />
                                <input type="reset" class="submit_btn" name="submit" id="submit" value="Clear" /></center>
			...
			?>
				...
				<div id="contact_form">
					...
					<div class="panel"id="seemessage"style="overflow:scroll">
