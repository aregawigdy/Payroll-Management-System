...
<form class="navbar navbar-fixed-top well1"style="height:30px">
	<center><h3><em>General Fuculty Staff's Status</em></h3></center>
</form>
		
<?php include("connection.php")
?>
<?php
$sql="select * from Faculty_staff";
...
if(!$query)
 ...
 $i = 0;
	...
	echo '</table></center><br/><center><button class="btn btn-success"style="margin-right:-900px"><a href="home.php"style="margin-right:10px">Back</a></button></center></form></body></html>';
